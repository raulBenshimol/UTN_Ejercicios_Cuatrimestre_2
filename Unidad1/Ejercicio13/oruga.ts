...
export default class Oruga extends SistemaTraccion{
    public constructor(){
        super("Rueda de caucho", 3, 400);
    }
    detalles(): string {
        return "Uso ideal para todo tipo de terreno, incorpora sensores Meke-M0 que le permiten conocer la temperatura ..."
    }
}