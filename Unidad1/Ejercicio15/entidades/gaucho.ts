...
export default class Gaucha extends Lanchas implements UsoMedico{
    
    public constructor(flotabilidad: number, estabilidad: string, maniobrabilidad: string, capacidadCarga: number) {
    super("Gaucha", flotabilidad, estabilidad, maniobrabilidad, capacidadCarga);
    }
    ...
    public mostrarInfo(): string {
        return `La lancha Gaucha está equipada para uso médico, se 
