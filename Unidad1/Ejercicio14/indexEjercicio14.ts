...
import SensorInfrarrojo from "./sensorInfrarojo";
import Taser from "./taser";
import BrazoRobotico from "./brazoRobotico";

function main(){
    const dron1 = new Dron()
    const taser1 = new Taser()
    const sensorInfrarojo1 = new SensorInfrarrojo()
    const brazoRobotico1 = new BrazoRobotico()

    dron1.mostrarDatos();
    
    dron1.asignarHerramienta(sensorInfrarojo1);
    dron1.mostrarDatos();
    
    dron1.asignarHerramienta(taser1);
    dron1.mostrarDatos();

    dron1.asignarHerramienta(brazoRobotico1);
    dron1.mostrarDatos();
